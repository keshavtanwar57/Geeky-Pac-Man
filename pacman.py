...
import pygame
import math
from question import show_question
...
blinky_img = pygame.transform.scale(
    pygame.image.load("Geeky-Pac-Man/assets/ghost_images/red.png"), (45, 45)
)
pinky_img = pygame.transform.scale(
    pygame.image.load("Geeky-Pac-Man/assets/ghost_images/pink.png"), (45, 45)
)
inky_img = pygame.transform.scale(
    pygame.image.load("Geeky-Pac-Man/assets/ghost_images/blue.png"), (45, 45)
)
    ...
    def move_clyde(self):
        ...
        if self.direction == 0:
            if self.target[0] > self.x_pos and self.turns[0]:
                ...
                if (self.target[1] > self.y_pos and self.turns[3]) or self.turns[3]:
                    self.direction = 3
                    self.y_pos += self.speed
                elif (self.target[1] < self.y_pos and self.turns[2]) or self.turns[2]:
                    self.direction = 2
                    self.y_pos -= self.speed
                elif (self.target[0] < self.x_pos and self.turns[1]) or self.turns[2]:
                    self.direction = 1
                    self.x_pos -= self.speed
            elif self.turns[0]:
            ...
            if self.target[1] > self.y_pos and self.turns[3]:
                ...
                if (self.target[1] > self.y_pos and self.turns[3]) or self.turns[3]:
                    ...
                    self.direction = 2
                    self.y_pos -= self.speed
                elif (self.target[0] > self.x_pos and self.turns[0]) or self.turns[0]:
                    self.direction = 0
                    self.x_pos += self.speed
            elif self.turns[1]:
                if self.target[1] > self.y_pos and self.turns[3]:
            ...
            if self.target[0] < self.x_pos and self.turns[1]:
                ...
                if( self.target[0] > self.x_pos and self.turns[0]) or self.turns[0]:
                    ...
                    self.direction = 1
                    self.x_pos -= self.speed
                elif (self.target[1] > self.y_pos and self.turns[3]) or self.turns[3]:
                    self.direction = 3
                    self.y_pos += self.speed
            elif self.turns[2]:
                if self.target[0] > self.x_pos and self.turns[0]:
